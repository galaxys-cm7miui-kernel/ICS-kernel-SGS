...
release/build-scripts/mkshbootimg.py release/boot.img arch/arm/boot/zImage release/ramdisks/captivatemtd/ramdisk.img release/ramdisks/captivatemtd/ramdisk-recovery.img
