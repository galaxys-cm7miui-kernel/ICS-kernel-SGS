...
release/build-scripts/mkshbootimg.py release/boot.img arch/arm/boot/zImage release/ramdisks/galaxysmtd/ramdisk.img release/ramdisks/galaxysmtd/ramdisk-recovery.img
